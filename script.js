...
const artData = {
    ...
    height: 10,
    palette: [
        { id: 1, color: "#87CEEB" }, // Light blue
        { id: 2, color: "#FFD700" }, // Yellow
        { id: 3, color: "#372e2aff" }, // Black
    ],
    pixels: [
        // Light Blue (id: 1)
        ...
        { x: 3, y: 3, paletteId: 2 }, { x: 4, y: 3, paletteId: 2 }, { x: 5, y: 3, paletteId: 2 }, { x: 6, y: 3, paletteId: 2 },
        { x: 3, y: 5, paletteId: 2 }, { x: 4, y: 5, paletteId: 2 }, { x: 5, y: 5, paletteId: 2 }, { x: 6, y: 5, paletteId: 2 },
        { x: 3, y: 7, paletteId: 2 }, { x: 4, y: 7, paletteId: 2 }, { x: 5, y: 7, paletteId: 2 }, { x: 6, y: 7, paletteId: 2 },

        // Black (id: 3)
        { x: 3, y: 2, paletteId: 3 }, { x: 6, y: 2, paletteId: 3 },
        { x: 3, y: 4, paletteId: 3 }, { x: 4, y: 4, paletteId: 3 }, { x: 5, y: 4, paletteId: 3 }, { x: 6, y: 4, paletteId: 3 },
        { x: 3, y: 6, paletteId: 3 }, { x: 4, y: 6, paletteId: 3 }, { x: 5, y: 6, paletteId: 3 }, { x: 6, y: 6, paletteId: 3 },
        { x: 4, y: 8, paletteId: 3 }, { x: 5, y: 8, paletteId: 3 },
